<%-- 
    Document   : edit-item
    Created on : 16 Jul 2025, 15:29:39
...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Edit Item - Pahana Edu Bookshop Billing</title>
        ...
        <style>
            ...
            /* Button Styles for Edit Item Page */
            ...
            /* Update Item Button Special Animation */
            ...
            @keyframes editPulse {
                0% {
                    box-shadow: 0 0 0 0 rgba(39, 63, 79, 0.7);
                }
                70% {
                    box-shadow: 0 0 0 10px rgba(39, 63, 79, 0);
                }
                100% {
                    box-shadow: 0 0 0 0 rgba(39, 63, 79, 0);
                }
            }
                ...
                <form method="post" action="item" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="description" name="description" class="form-control" value="<%= item.getDescription() %>" />
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="stock" name="stock" class="form-control" value="<%= item.getStock() %>" min="0" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="category" name="category" class="form-control" value="<%= item.getCategory() %>" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="author" name="author" class="form-control" value="<%= item.getAuthor() %>" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="publisher" name="publisher" class="form-control" value="<%= item.getPublisher() %>" />
                        </div>
                    </div>
                    <div class="mb-4">
                        <label for="status" class="form-label">Status</label>
                        <select id="status" name="status" class="form-select">
                            <option value="active" <%= "active".equalsIgnoreCase(item.getStatus()) ? "selected" : "" %>>Active</option>
                            <option value="inactive" <%= "inactive".equalsIgnoreCase(item.getStatus()) ? "selected" : "" %>>Inactive</option>
                        </select>
                    </div>
