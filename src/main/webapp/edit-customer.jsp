<%-- 
    ...
    Created on : 16 Jul 2025, 15:25:47
...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Edit Customer - Pahana Edu Bookshop Billing</title>
        ...
        <style>
            ...
            /* Button Styles for Edit Customer Page */
            ...
            /* Primary Button - Update Customer */
    ...
    <body>
        ...
        <div class="main-content d-flex justify-content-center align-items-center" style="min-height:80vh;">
            <div class="dashboard-card" style="max-width: 480px; width:100%;">
                <div class="mb-4 text-center">
                    <h2 class="edit-customer-title">
                ...
                <form method="post" action="customer" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="<%= c.getName() %>" required autofocus />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="address" name="address" class="form-control" value="<%= c.getAddress() %>" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="phone" name="phone" class="form-control" value="<%= c.getPhone() %>" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control" value="<%= c.getEmail() %>" />
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="unitsConsumed" name="unitsConsumed" class="form-control" value="<%= c.getUnitsConsumed() %>" min="0" />
                        </div>
                    </div>
                    <div class="mb-4">
                ...
                <a href="customer?action=list" class="btn btn-outline-primary mt-3 d-block text-center">
