<%-- 
    ...
    Created on : 16 Jul 2025, 15:20:14
...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Add New Customer - Pahana Edu Bookshop Billing</title>
        ...
        <style>
            ...
            /* Button Styles for Add Customer Page */
                ...
                <form method="post" action="customer" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="unitsConsumed" name="unitsConsumed" value="0" min="0" class="form-control" />
                        </div>
                    </div>
                    <div class="mb-4">
