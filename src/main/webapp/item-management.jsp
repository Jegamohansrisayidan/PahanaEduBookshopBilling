<%-- 
    ...
    Created on : 16 Jul 2025, 15:29:03
...
<%
    ...
    if (items == null) {
        items = new com.pahana.pahanaedubookshopbilling.dao.ItemDAO().getAllItems();
    }
%>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <title>Item Management - Pahana Edu Bookshop Billing</title>
        ...
        <style>
            ...
            /* Button Styles for Item Management Page */
            ...
            .btn-primary::before {
                ...
                width: 100%;
                height: 100%;
                background: linear-gradient(90deg, transparent, rgba(239, 238, 234, 0.1), transparent);
            ...
            .btn-sm.btn-danger:hover::before {
                left: 100%;
            }
            ...
            /* Button Pulse Animation on Active */
        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="dashboard-header mb-4">
                    ...
                    <p class="dashboard-subtitle">View and manage all Books and Products.</p>
                </div>
                <div class="dashboard-card">
                    <div class="mb-3 d-flex flex-wrap gap-2">
                        <a href="item?action=add" class="btn btn-primary">
                        ...
                        <table class="table table-striped table-bordered align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="item?action=edit&itemId=<%= item.getItemId() %>" class="btn btn-sm btn-primary">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="item?action=delete&itemId=<%= item.getItemId() %>" class="btn btn-sm btn-danger ms-1" onclick="return confirm('Delete this item?');">
